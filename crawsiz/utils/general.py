...
from crawsiz import crawsiz


def root_directory():
    """Getermine the root directory in which crawsiz is installed.
    ...
    """
    # Get the directory of the crawsiz library
    crawsiz_dir = crawsiz.__path__[0]
    components = crawsiz_dir.split(os.sep)
